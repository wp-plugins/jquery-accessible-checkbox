...
JQuery Accessible Checkbox is checkbox controling the number of your blog's recent posts, recent comments
and archives shown in an accordion and uses the JQuery WAI-ARIA enabled accordion and checkbox.
